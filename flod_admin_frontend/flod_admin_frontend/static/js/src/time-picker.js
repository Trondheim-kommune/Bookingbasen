...
(function (ns, undefined) {
    ...
    ns.TimePicker = Backbone.View.extend({
        ...
        render: function (from, to) {
            ...
            this.$("#fromSelect").append(this.start_times.map(function (model) {
                return new OptionView({"model": model}).render().$el;
            }));
            this.$("#toSelect").append(this.end_times.map(function (model) {
                return new OptionView({"model": model}).render().$el;
            }));
            return this;
        }
