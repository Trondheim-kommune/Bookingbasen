...
(function (ns, undefined) {
    ...
    var Application = Backbone.Model.extend({
        ...
        getDisplayData: function () {
            ...
            var person = (this.has("person"))
                ? this.get("person").toJSON()
                : null;

            var organisation = (this.has("organisation"))
                ? this.get("organisation").toJSON()
                : null;
        ...
        toJSON: function () {
            ...
            if (this.has("organisation")) {
                data.organisation = {"uri": this.get("organisation").get("uri")};
            }
            if (this.has("isArrangement")) {
                data.isArrangement = this.get("isArrangement");
            }
